...
public class KategoriController : Controller
{
    ...
    {
        var kategoriler = _context.Kategoriler.Select(i => new KategoriGetModel { Id = i.Id, KategoriAdi = i.KategoriAdi, Url = i.Url, UrunSayisi = i.Uruns.Count }).ToList();
    ...
    public ActionResult Edit(int id, KategoriEditModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (entity != null)
            {
                ...
                _context.SaveChanges();
                TempData["Message"] = $"{entity.KategoriAdi} kategorisi güncellendi.";
                return RedirectToAction("Index");
            }
        }
        return View(model);
